...
- [ ] Change the programming language (target language to be decided).
- [ ] Change model provider from Minimax to a configurable variable (env/config driven, no hardcoded provider).
